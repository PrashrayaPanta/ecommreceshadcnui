  ...
  return (
    <div>
      ...
      <div class="grid  grid-cols-2 md:grid-cols-4 gap-6 p-4">
        ...
        {/* <div class="bg-white shadow-md rounded-md text-center p-4">
          <img
            src="../image-2.jpg"
          ...
          <p class="line-through text-gray-400 font-semibold text-lg">$500</p>
        ...
        {/* <div class="bg-white shadow-md rounded-md text-center p-4">
          ...
          <p class="line-through text-gray-400 font-semibold text-lg bg-pink-700">
            $500
          </p>
          <p class="text-2xl font-bold text-gray-900 mt-4">$500</p>

          <div className="mt-5 flex justify-center bg-amber-300">
            <button class=" text-black hover:text-white flex px-4 py-2 border rounded-md hover:bg-black transition">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 "
        ...
        {/* <div class="bg-white shadow-md rounded-md p-6  text-center">
          ...
          <p class="text-2xl font-bold text-gray-900 mb-4">$1,500</p>
          <button class="mt-auto flex items-center gap-2 px-4 py-2 border rounded-md hover:bg-gray-100 transition">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
              fill="none"
